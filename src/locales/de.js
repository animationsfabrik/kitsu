export default {
  ...
  productions: {
    sequence_management: 'Sequenz-management',
    ...
    shot_management: 'Shot-management',
    asset_management: 'Asset-management',
    task_management: 'Todos',
    current: 'Selected production',
    createfs_text: 'Are you sure you want to create folders?',
    delete_text: 'Are you sure you want to remove {name} from your database?',
  ...
  tasks: {
    ...
    hide_additional_info: 'Hide additional info',
